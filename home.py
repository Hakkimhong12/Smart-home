...
## Final code for Smart home. Everything work well.
import time
...
class HomeAutomation:
    def __init__(self):
        ...
        self.fan_pin1 = self.board.get_pin('d:2:o')
        self.fan_pin2 = self.board.get_pin('d:3:o')
        self.fan_pin3 = self.board.get_pin('d:4:o')
        ...
        with mp_hand.Hands(min_detection_confidence=0.5, min_tracking_confidence=0.5) as hands:
            while True:
                ...
                if len(lmList) != 0:
                    ...
                    if total == 0:
                        cv2.rectangle(image, (20, 410), (340, 460), (0, 255, 0), cv2.FILLED)
                        cv2.putText(image, "", (45, 375), cv2.FONT_HERSHEY_SIMPLEX,
                                    1, (255, 0, 0), 4)
                        cv2.putText(image, "LED BOTH FLOOR", (50, 450), cv2.FONT_HERSHEY_SIMPLEX,
                        1, (255,0,0), 4)
                        self.led1_pin.write(1)
                        ...
                        cv2.rectangle(image, (20, 410), (270, 460), (0, 255, 0), cv2.FILLED)
                        cv2.putText(image,"", (45, 375), cv2.FONT_HERSHEY_SIMPLEX,
                                    1, (255, 0, 0), 5)
                        cv2.putText(image,"FIRST FLOOR", (50, 450), cv2.FONT_HERSHEY_SIMPLEX,
                                    1, (255, 0, 0), 4)
                        self.led1_pin.write(0)
                        self.led2_pin.write(1)
                        self.fan_pin1.write(0)
                        ...
                        cv2.rectangle(image, (20, 410), (300, 460), (0, 255, 0), cv2.FILLED)
                        cv2.putText(image, "", (45, 375), cv2.FONT_HERSHEY_SIMPLEX,
                                    1, (255, 0, 0), 5)
                        cv2.putText(image,"SECOND FLOOR", (50, 450), cv2.FONT_HERSHEY_SIMPLEX,
                                    1, (255, 0, 0), 4)
                        self.led1_pin.write(1)
                        ...
                        cv2.putText(image, "", (45, 375), cv2.FONT_HERSHEY_SIMPLEX,
                                    0.5, (255, 0, 0), 5)
                        cv2.putText(image, "FAN ON", (90, 450), cv2.FONT_HERSHEY_SIMPLEX,
                                    1, (255, 0, 0), 4)
                        self.led1_pin.write(0)
                        self.led2_pin.write(0)
                        self.fan_pin1.write(1)
                        ...
                        cv2.putText(image, "", (45, 375), cv2.FONT_HERSHEY_SIMPLEX,
                                    1, (255, 0, 0), 5)
                        cv2.putText(image, "ALL ON", (90, 450), cv2.FONT_HERSHEY_SIMPLEX,
                                    1, (255, 0, 0), 4)
                        self.led1_pin.write(1)
                        self.led2_pin.write(1)
                        self.fan_pin1.write(1)
                        ...
                        cv2.putText(image, "", (45, 375), cv2.FONT_HERSHEY_SIMPLEX,
                                    1, (255, 0, 0), 5)
                        cv2.putText(image, "ALL OFF", (90, 450), cv2.FONT_HERSHEY_SIMPLEX,
                                    1, (255, 0, 0), 4)
                        self.led1_pin.write(0)
                        self.led2_pin.write(0)
                        self.fan_pin1.write(0)
